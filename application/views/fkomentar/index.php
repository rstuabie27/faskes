          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-2" data-aos="zoom-in">
                <a class="btn btn-success nav-link px-4 text-white btn-block mb-3" href="<?php echo site_url(); ?>/admin/<?php echo $maps ?>">Maps</a>
              </div>
            </div>
          </div>
        </section>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-8 text-left">
                                <button type="submit" class="btn btn-success text-white">
                                    <a class="text-white" href="<?php echo site_url(); ?>/fkomentar/create">Tambahkan</a>
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    var gallery = new Vue({
        ...
        data: {
            ...
            photos: [{
                    id: 1,
                    url: "<?php echo base_url(); ?>public/images/faskes-details-<?php echo $gambar1 ?>",
                },
                {
                    id: 2,
                    url: "<?php echo base_url(); ?>public/images/faskes-details-<?php echo $gambar2 ?>",
                },
                {
                    id: 3,
                    url: "<?php echo base_url(); ?>public/images/faskes-details-<?php echo $gambar3 ?>",
                },
                {
                    id: 4,
                    url: "<?php echo base_url(); ?>public/images/faskes-details-<?php echo $gambar4 ?>",
                },
            ],
        },
        methods: {
