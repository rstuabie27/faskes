<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Form Menambah Faskes</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('faskes/save', ['action' => 'post']); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        <input id="kecamatan_id" name="kecamatan_id" type="text" class="form-control">
                    </div>
                </div>
                <div class="form-group row">
